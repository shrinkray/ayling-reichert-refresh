...
$message = '';
$massages = array();
$messages[1] = __( 'Options saved', 'otw_wpl' );
			...
			<div id="post-body">
				<div id="post-body-content">
					<div class="form-field">
						<label for="otw_sbm_promotions"><?php _e('Show OTW Promotion Messages in my WordPress admin', 'otw_wpl'); ?></label>
					...
					<p class="submit">
						<input type="submit" value="<?php _e( 'Save Options', 'otw_wpl') ?>" name="submit" class="button button-primary button-hero"/>
					</p>
				</div>
			</div>
		</form>
