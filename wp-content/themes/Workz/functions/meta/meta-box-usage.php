...
$workz_meta_boxes[] = array(
	'id' => 'slides_meta',
	'title' => __('Slide Options','workz'),
	'pages' => array('slides'),

	'fields' => array(
		array(
            'name' => __('Slide URL','workz'),
            'desc' => __('Enter a URL to link this slide to - perfect for linking slides to pages on your site or other sites. Optional.','workz'),
